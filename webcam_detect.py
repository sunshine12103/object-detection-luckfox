...
class TDTULogoDetector:
    def __init__(self, model_path="runs/train/logo_tdtu4/weights/best.pt", data_path="LOGO-TDTU.v2i.yolov8/data.yaml"):
        """
        Khởi tạo detector cho logo TDTU
        """
        ...
        try:
            ...
            print(f"⚠️ Không tìm thấy model trained, sử dụng model gốc...")
